...
video1 = Video.new({title: 'every time I ask my PM for help', description: 'this happens a lot', author_id: 1})
...
video2 = Video.new({title: 'This Is America but it\'s Amerika by Rammstein', description: 'this is America, Amerika ist wunderbar', author_id: 3})
...
video3 = Video.new({title: 'this one has no thumbnail', description: 'you can do this!', author_id: 2})
...
video4 = Video.new({title: 'hey remember Ned\'s Declassified School Survival Guide', description: 'cause I sure do', author_id: 3})
...
video5 = Video.new({title: 'one more without a thumbnail and also with a really long name so yall can see how this app handles text overflows which I will admit is not a perfect solution but it is good enough for now', description: 'descriptions are another shortcoming', author_id: 1})
...
video6 = Video.new({title: 'W H A T U P P P P', description: 'Jeremy Davies (born Jeremy Boring; October 8, 1969) is an American film and television actor.', author_id: 3})
